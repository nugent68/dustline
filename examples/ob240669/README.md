...
stage from a local cache instead of the ~2 h archive fetch. Numbers are from the v0.4.0
stack: the 900 Å–6 µm model cache and the tile-based PS1 fetch; the v0.2–0.3 run on the
2500–25000 Å cache gave R_V = 2.88 ± 0.53 from 986 stars and a clump column of 3.28.)

## Result

- **R_V = 2.84 ± 0.48** (median ± MAD, 946 stars with A_V ≥ 2); 16–84 %: 2.51–4.15.
- **Red-clump anchor:** E(J−Ks) = 0.52 from 1,820 clump-window stars at Ks = 12.65,
  giving A_V = 3.33 ± 0.62 (A_Ks = 0.32) at D_RC = 6.1 kpc.
- **A_I(D)** (A_I/A_V = 0.583 under the measured law):

  | D (kpc) | A_I | 16–84 % | N | |
  |---|---|---|---|---|
  | 1 | 0.41 | 0.25–0.71 | 108 | |
  | 2 | 0.84 | 0.59–1.17 | 460 | |
  | 3 | 1.00 | 0.73–1.42 | 403 | |
  | 4 | 1.17 | 0.93–1.64 | 210 | |
  | 5 | 1.31 | 1.01–1.84 | 91 | |
  | 6.1 | 1.84 | 1.19–2.06 | 17 | last parallax bin |
